  ...
  const roles = [
    {
      ...
      href: "https://merchants.staging.dispattch.dev",
      icon: Package,
    },
    {
    ...
    {
      title: tPortals("demo.title"),
      description: tPortals("demo.description"),
      href: "https://demo.dispattch.dev",
      icon: Zap,
    },
  ];
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/60 backdrop-blur-2xl border-b border-border/50">
        <div className="max-w-7xl mx-auto flex items-center justify-between h-24 px-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <ThemeToggle />
            <a
              href="https://dispatch-2.gitbook.io/integrate-with-dispatch/"
              target="_blank"
        ...
        <div className="relative max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="animate-fade-in">
            <div className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 rounded-full px-4 py-2 mb-2">
              ...
              <span className="text-md font-small text-primary tracking-wide">
                {tHero("badge")}
              </span>
            </div>
          </div>
      ...
      <footer className="border-t border-border/40 py-10">
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-center gap-6">
            <p className="text-xs text-muted-foreground/100">
              {tFooter("copyright")}
            </p>
          </div>
        </div>
