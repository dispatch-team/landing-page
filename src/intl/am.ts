...
const am: Messages = {
  ...
  features: {
    sectionLabel: "ባህሪያት",
    headline1: "የአቅርቦት ስራዎን ለማሳደግ",
    headline2: "የሚያስፈልጉዎት ሁሉ።",
    shipmentManagement: {
      title: "የጭነት አስተዳደር",
      description: "ሁሉንም አቅርቦቶችዎን ከአንድ ዳሽቦርድ ይፍጠሩ፣ ያስተዳድሩ እና ይከታተሉ።",
    },
    fleetCoordination: {
      title: "የተሽከርካሪዎች ቅንጅት",
      description: "ከፍተኛ የኩሪየር አጋሮች ጋር ይገናኙ እና ስርጭትን ያለ ምንም ችግር ያስተዳድሩ።",
    },
    performanceAnalytics: {
      title: "የአፈጻጸም ትንታኔ",
      description: "በአቅርቦት ስኬት መጠኖች፣ ጊዜያት እና የኩሪየር አፈጻጸም ላይ ግንዛቤዎችን ያግኙ።",
    },
    apiIntegration: {
      title: "የ API ውህደት",
      description: "በእኛ ጠንካራ እና ለገንቢዎች ምቹ በሆነ API የስራ ፍሰቶችዎን አውቶማቲክ ያድርጉ።",
    },
    locationIntelligence: {
      title: "የአካባቢ መረጃ",
      description: "ለአዲስ አበባ ውስብስብ የአድራሻ ስርዓት ትክክለኛ የቦታ አቀማመጥ እና የመንገድ ምርጫ።",
    },
    courierRatings: {
      title: "የኩሪየር ደረጃ አሰጣጥ",
      description: "በአውታረ መረቡ ውስጥ ከፍተኛ ጥራት ያለው አገልግሎት ለማረጋገጥ ኩሪየሮችን እና ሾፌሮችን ደረጃ ይስጡ።",
    },
  },

  // ─── How It Works ───────────────────────────────────────────────────────────
  howItWorks: {
    sectionLabel: "እንዴት ይሰራል",
    headline: "ሎጂስቲክስዎን ለማቀላጠፍ ሶስት ቀላል ደረጃዎች።",
    step1: {
      title: "ተገናኝ እና አዋቅር",
      description: "እንደ ነጋዴ ይመዝገቡ እና የእኛን API ያዋህዱ ወይም ለመጀመር ቀላል የሆነውን ዳሽቦርድ ይጠቀሙ።",
    },
    step2: {
      title: "ጭነቶችን ፍጠር",
      description: "የሚገኙትን የኩሪየር አጋሮች እና የዋጋ ዝርዝር ወዲያውኑ ለማየት የመነሻ እና መድረሻ ዝርዝሮችን ያስገቡ።",
    },
    step3: {
      title: "ተከታተል እና ተንትን",
      description: "አቅርቦቶችን በቅጽበት ይከታተሉ፣ በ webhooks ማሻሻያዎችን ይቀበሉ እና አፈጻጸምን ይተንትኑ።",
    },
  },

  // ─── Portals ───────────────────────────────────────────────────────────────
  portals: {
    sectionLabel: "የመግቢያ ገጾች",
    headline: "የመግቢያ ገጾቻችንን ያስሱ",
    subheading: "በአቅርቦት ስነ-ምህዳር ውስጥ ላለ እያንዳንዱ አካል የተዘጋጁ ልምዶች።",
    merchant: {
      title: "የነጋዴ መግቢያ",
      description: "ትዕዛዞችን፣ አጋሮችን እና የንግድ ትንታኔዎችን ያስተዳድሩ። ጭነቶችን ይፍጠሩ እና በቅጽበት ይከታተሉ።",
    },
    supervisor: {
      title: "የሱፐርቫይዘር መግቢያ",
      description: "በከተማው ውስጥ የኩሪየር ስራዎችን ይቆጣጠሩ፣ ሾፌሮችን ያስተዳድሩ እና የተሽከርካሪዎችን አፈጻጸም ይከታተሉ።",
    },
    admin: {
      title: "የአስተዳዳሪ መግቢያ",
      description: "አጠቃላይ የሲስተም ውቅር፣ የመድረክ ቁጥጥር እና የተጠቃሚ አስተዳደር ለመላው አውታረ መረብ።",
    },
    demo: {
      title: "የሙከራ መተግበሪያ",
      description: "በቅድመ-ውቅር ናሙና መረጃ አማካኝነት መድረካችንን በሙከራ አካባቢ ይለማመዱ።",
    },
  },
  ...
  cta: {
    headline1: "አቅርቦቶችዎን",
    headline2: "ለማቅለል ዝግጁ ነዎት?",
    subheading: "ደንበኞቻቸውን በፍጥነት ለመድረስ Dispatch የሚጠቀሙ ነጋዴዎችን ይቀላቀሉ።",
    courierLogin: "የኩሪየር መግቢያ",
  },

  // ─── Footer ────────────────────────────────────────────────────────────────
  footer: {
    merchant: "የነጋዴ መግቢያ",
    supervisor: "የሱፐርቫይዘር መግቢያ",
    admin: "የአስተዳዳሪ መግቢያ",
    downloadDriverApp: "የሾፌር መተግበሪያ አውርድ",
    copyright: "© 2026 Dispatch. መብቱ በህግ የተጠበቀ ነው።",
  },
